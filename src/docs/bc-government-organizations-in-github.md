...
slug: "/docs/bc-government-organizations-in-github"
...
page_purpose: Describes the different BC Government organizations in GitHub, what they're used for, who can use them, and how to access them.
...
The BC Devops team uses <a href="https://github.com" target="_blank">GitHub</a> to host open code and repositories. Using GitHub we're able to do the following:
